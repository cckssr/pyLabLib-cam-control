...
class TutorialBox(param_table.ParamTable):
    ...
    def setup(self, main_frame):
        ...
        self.vs["prevch"].connect(
            exsafe(lambda: self.select_stage(self._prev_chapter(self.stage[0])))
        )
    ...
    def setup_display(self, chapter, stage):
        ...
        prevst_label = (
            ...
            if prevst is None
                ...
                self.get_stage(chapter, prevst)[0][1]
                if prevstch == chapter
        ...
        nextst_label = (
            ...
            if nextst is None
                ...
                self.get_stage(chapter, nextst)[0][1]
                if nextstch == chapter
    ...
    def get_all_stages(self):
        ...
        stages = {
            ...
            "processing": [
                ...
                "bgsub/overview",
                "bgsub/method",
                "bgsub/method_snapshot",
                "bgsub/method_running",
                "bgsub/comb_mode",
                "bgsub/grab",
                "bgsub/save",
                "bgsub/enable",
                "slowdown/overview",
                "slowdown/source_fps",
                "slowdown/slowdown_fps",
                "slowdown/slowdown_buffer",
                "slowdown/enable",
            ],
        }
    ...
    def get_stage(self, chapter, stage=None, show=False):
        ...
        if chapter == "cam_status":
            ...
            if show and self.main_frame.compact_interface:
                self.main_frame.control_tabs.set_by_name("cam_tab")
            cont = (
                self.main_frame.c["cam_controller/camstat"]
                if stage != "activity_indicator"
                else self.main_frame.c["activity_indicator"]
            )
            stages = {
                "overview": (
                    "Overview",
        ...
        if chapter == "save_status":
            ...
            if show and self.main_frame.compact_interface:
                self.main_frame.control_tabs.set_by_name("save_tab")
            cont = (
                self.main_frame.c["cam_controller/savestat"]
                if stage != "stream_mode"
                else self.main_frame.c["cam_controller/savebox/params"]
            )
            stages = {
                "overview": (
                    "Overview",
                ...
                "pretrigger": (
                    ...
                    [
                        "frames/pretrigger_frames",
                        "frames/pretrigger_skipped",
                        "frames/pretrigger_ram",
                    ],
                ),
            }
        if chapter == "extras":
        ...
        if chapter == "processing":
            ...
            stages = {
                ...
                "bgsub/method_snapshot": (
                    "Background subtraction / Snapshot",
                    (
                ...
                "bgsub/method_running": (
                    "Background subtraction / Running",
                    (
                ...
                "bgsub/comb_mode": (
                    "Background subtraction / Combination",
                    (
                ...
                "bgsub/grab": (
                    "Background subtraction / Grabbing",
                    (
